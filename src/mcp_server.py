...
async def search_established_companies(province=None, city=None, district=None, establish_date=None) -> dict:
    ...
    :param province  String  省份最多5个，多个省份用英文逗号隔开,当查询全国时，不设province参数。province参数取两个字，不要有省或市
    :param city String  城市,多个城市用英文逗号隔开,city参数必须设为地级市
    :param district String  区县,多个区县用英文逗号隔开
    :param establishDate   String  成立期限，格式如2023-01-12@2023-11-11 表示2012年1月12日到2023年11月11日之间成立的企业，2023-01-12@2023-01-12 表示2012年1月12日成立的企业，2023-01-12@表示2023年1月12号及之后成立的企业， @2023-11-11表示23年11月11日之前成立的公司。 2023-01-01@2023-12-31表示23年成立的企业。
    ...
    try:
        params = {'province': province, 'city':city, 'district':district, 'establishDate':establish_date, 'company_type':'有限责任公司,股份有限公司,股份合作公司,国有企业,央企,集体所有制,全民所有制,独资企业,有限合伙,普通合伙,外商投资企业,港、澳、台商投资企业,联营企业,私营企业'}
...
async def search_established_selfemployed(province=None, city=None, district=None, establish_date=None) -> dict:
    ...
    :param province  String  省份最多5个，多个省份用英文逗号隔开,当查询全国时，不设province参数。province参数取两个字，不要有省或市
    :param city    String  城市,多个城市用英文逗号隔开,city参数必须设为地级市
    :param district String  区县,多个区县用英文逗号隔开,district参数必须完整，例如包含市、县或区
    :param establishDate   String  成立期限，格式如2023-01-12@2023-11-11 表示2012年1月12日到2023年11月11日之间成立的企业，2023-01-12@2023-01-12 表示2012年1月12日成立的企业，2023-01-12@表示2023年1月12号及之后成立的企业， @2023-11-11表示23年11月11日之前成立的公司。 2023-01-01@2023-12-31表示23年成立的企业。
    ...
    try:
        params = {'province': province, 'city':city, 'district':district, 'establishDate':establish_date, 'company_type':'个体工商户'}
        return await SearchApiAdapter().invoke(params)
    except Exception as e:
        logger.error(e)
        return "查询统计个体户失败！"
...
async def search_companies(province=None, city=None, district=None, company_status=None) -> dict:
    ...
    :param city    String  城市,多个城市用英文逗号隔开,city参数必须设为地级市
    :param district String  区县,多个区县用英文逗号隔开,district参数必须完整，例如包含市、县或区
    :param company_status   String  企业状态可以设为"存续,在业"、"吊销"、"注销"、"迁入"、"迁出"、"撤销"、"清算"、"停止"、"其他"
    ...
    try:
        params = {'province': province, 'city': city, 'district':district, 'company_status': company_status, 'company_type': '有限责任公司,股份有限公司,股份合作公司,国有企业,央企,集体所有制,全民所有制,独资企业,有限合伙,普通合伙,外商投资企业,港、澳、台商投资企业,联营企业,私营企业'}
        return await SearchApiAdapter().invoke(params)
    except Exception as e:
        logger.error(e)
        return "查询统计企业失败！"
...
async def search_selfemployed(province=None, city=None, district=None, company_status=None) -> dict:
    ...
    '''
    try:
        params = {'province': province, 'city': city, 'district':district, 'company_status': company_status, 'company_type': '个体工商户'}
        return await SearchApiAdapter().invoke(params)
    except Exception as e:
        logger.error(e)
        return "查询统计个体户失败!"
...
async def get_company_info(company_name: str) -> dict:
    ...
    """
    try:
        return await ApiAdapter('http://api.shuidi.cn/utn/ic/Base/V1').invoke({'keyword': company_name})
    except Exception as e:
        logger.error(e)
        return f"获取企业[{company_name}]基础信息失败!"
...
async def get_company_partner(company_name:str) -> dict:
    ...
    try:
        ...
        logger.error(e)
        return f"获取企业[{company_name}]股东信息失败!"
...
async def get_stie_score(company_name:str) -> dict:
    ...
    try:
        ...
        logger.error(e)
        return f"评估企业[{company_name}]科创能力失败！"
...
async def search_company_risk(company_name:str) -> dict:
    ...
    try:
        ...
        logger.error(e)
        return f"获取企业[{company_name}]风险信息失败!"
...
async def get_company_honor(company_name:str) -> dict:
    ...
    try:
        ...
        logger.error(e)
        return  f"获取企业[{company_name}]荣誉资质信息失败!"
...
async def get_company_contact(company_name:str) -> dict:
    ...
    try:
        ...
        logger.error(e)
        return f"获取企业[{company_name}]联系方式失败!"
...
async def get_company_investment(company_name:str) -> dict:
    ...
    try:
        ...
        logger.error(e)
        return f"获取企业[{company_name}]对外投资信息失败!"
...
async def get_company_cert(company_name:str) -> dict:
    ...
    try:
        ...
        logger.error(e)
        return f"获取企业[{company_name}]资质证书失败!"
...
async def get_person_related_company(company_name:str, person_name:str) -> dict:
    ...
    try:
        ...
        logger.error(e)
        return f"获取[{company_name}:{person_name}]的关联公司信息失败!"
...
async def get_company_controller(company_name:str) -> dict:
    ...
    try:
        ...
        logger.error(e)
        return f"获取企业[{company_name}]的实控人信息失败!"
...
async def get_company_benificalowner(company_name:str) -> dict:
    ...
    try:
        ...
        logger.error(e)
        return f"获取企业[{company_name}]受益所有人信息失败!"
